...
-   If you receive error messages about not having a LaTeX installation, run `tinytex::install_tinytex()`. This installs a small, efficient version of LaTeX that has everything R needs to knit PDFs.
...
\begin{quote}
Plant mass varied significantly according to treatment type (p = `r round(plant_aov_summary[[1]][["Pr(>F)"]][[1]], 3)`).
\end{quote}
